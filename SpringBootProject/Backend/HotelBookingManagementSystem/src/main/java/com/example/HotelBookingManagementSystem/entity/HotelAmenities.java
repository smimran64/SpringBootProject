...
public class HotelAmenities {
    ...
    public HotelAmenities(Long id, boolean freeWifi, boolean freeParking, boolean swimmingPool, boolean gym, boolean restaurant, boolean roomService, boolean airConditioning, boolean laundryService, boolean wheelchairAccessible, boolean healthServices, boolean playGround, boolean airportSuttle, boolean breakFast, Hotel hotel) {
        this.id = id;
